...
public class ITTestMultiWriteBatch {

    public static StreamTableEnvironment tableEnv;

    public static String PATH = "file:///Users/hunter/workspace/hudipr/multiwriter-0.12.0-5/hudi-debug/target/ITTestMultiWriteBatch";
    ...
    @Test
    public void testRunAll() throws ExecutionException, InterruptedException {
        ...
        String insert2 = "insert into sink_2(id, age, ts, par) values( 'id', 1 , '1','par1')";
        String insert1 = "insert into sink_1(id, name, ts, par) values('id', 'name' , '1', 'par1')";
    ...
    @Test
    public void testJob1() throws ExecutionException, InterruptedException {
        String sink_1 = "create table sink_1(\n" +
                "  id STRING,\n" +
                "  name STRING,\n" +
                "  age int,\n" +
    ...
    @Test
    public void testJob2() throws ExecutionException, InterruptedException {
        String sink_2 = "create table sink_2(\n" +
                "  id STRING,\n" +
                "  name STRING,\n" +
                "  age int,\n" +
