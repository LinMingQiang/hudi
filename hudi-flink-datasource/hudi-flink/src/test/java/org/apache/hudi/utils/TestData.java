...
public class TestData {
  ...
  public static void checkWrittenDataCOW(
    ...
    // 1. init flink table
    HoodieTableMetaClient metaClient = HoodieTestUtils.init("file://" + basePath.getAbsolutePath());
    HoodieWriteConfig config = HoodieWriteConfig.newBuilder().withPath("file://" + basePath.getAbsolutePath()).build();
